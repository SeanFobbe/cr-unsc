...
Hard tests are integrated into the latter part of functions to act as data quality gateways, soft tests are run on the final data and their results reported here.
...
```{r, CR-UNSC_30_Citations_blue, fig.width = 20, fig.height = 20, fig.pos = "p", fig.cap = "The citation network of the UNSC"}
