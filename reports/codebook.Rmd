...
The raw data for all stages of the data pipeline (\enquote{targets}) was stored and is published together with the source code. The original files acquired from the UN Digital Library are part of the dataset itself. We exclude only HTML files from this.
