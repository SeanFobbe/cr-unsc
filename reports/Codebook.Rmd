...
```{r, CR-UNSC_Workflow_blackwhite, fig.width = 12, fig.height = 14, fig.pos = "p", fig.cap = "The complete data set compilation process."}
...
The CR-UNSC comes with a specialized variant of the dataset that extracts all citations from UNSC resolutions to other UNSC resolutions and UNGA resolutions. This graph (network) representation of citations is available in GraphML format.
