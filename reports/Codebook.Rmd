...
```{r, CR-UNSC_31_Citations_Degree, fig.width = 18, fig.height = 12, fig.pos = "p", fig.cap = "Degree distribution of the UNSC citation network."}
...
```{r, CR-UNSC_32_Citations_In-Degree, fig.width = 18, fig.height = 12, fig.pos = "p", fig.cap = "In-Degree distribution of the UNSC citation network."}
...
```{r, CR-UNSC_30_Citations_blackwhite, fig.width = 20, fig.height = 20, fig.pos = "p", fig.cap = "The citation network of the UNSC"}
...
```{r, CR-UNSC_EN_03_Distributions_Voting, fig.height = 10, fig.width = 8.3}
...
ggplot(dt.allmetrics, aes(x = value,
                             y = variable))+
    geom_violin()+
    stat_summary(fun.data = f.boxplot.body,
                 geom = "errorbar",
    ...
    stat_summary(fun.data = f.boxplot.outliers,
                 ...
                 size =  0.5,
                 alpha = 0.1)+
    scale_y_discrete(labels = rev(names))+
    theme_bw() +
    labs(
        title = paste(prefix.figuretitle,
                      "| Distributions of Voting Proportions"),
        caption = caption,
        x = "Value",
        y = "Voting Proportion"
    )+
