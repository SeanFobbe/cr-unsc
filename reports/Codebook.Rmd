...
All resolutions issued by the UNSC in all six official UN languages in PDF format as published by the UN Digital Library. Includes resolutions 1 through 899 in English with a new and enhanced OCR text layer created with an advanced LSTM neural network machine learning engine.  We decided against including other language versions in this PDF archive to keep file size reasonable. The data pipeline produces PDF files with enhanced OCR text for all languages, however.
