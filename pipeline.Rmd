...
tar_target(files.record.res,
                f.download(url = dt.record.final$url_record,
                           ...
                           debug.toggle = config$debug$download$toggle,
                           debug.files = config$debug$download$files),
                format = "file")
...
<!-- ```{targets tar.download.text.en} -->
<!-- tar_target(files.pdf.text.en, -->
<!--                 f.download(url = dt.download$url_text_en, -->
<!--                            filename = paste0(dt.download$doc_id, "_EN.pdf"), -->
<!--                            dir = "pdf_en", -->
<!--                            sleep.min = 0.3, -->
<!--                            sleep.max = 1, -->
<!--                            retries = 3, -->
...
<!-- list(tar_target(files.txt.en, -->
<!--                 f.tar_pdf_extract(x = files.pdf.text.en, -->
<!--                                   outputdir = "text.txt.en", -->
<!-- 								  multicore = config$parallel$extractPDF, -->
<!--                                   cores = fullCores), -->
<!--                 format = "file"), -->
<!--      tar_target(dt.unsc.text.en, -->
<!--                 f.readtext(x = files.txt.en, -->
