...
values <- tibble::tibble(
                      ...
                      url = c(quote(dt.download.final[!is.na(url_res_ar)]$url_res_ar),
                              ...
                              quote(dt.download.final[!is.na(url_res_draft_en)]$url_draft_en),
                              quote(dt.download.final[!is.na(url_res_meeting_en)]$url_meeting_en)),
                      filename = c(quote(paste0(dt.download.final[!is.na(url_res_ar)]$doc_id, "_AR.pdf")),
                                   ...
                                   quote(paste0(dt.download.final[!is.na(url_res_draft_en)]$doc_id, "_Draft_EN.pdf")),
                                   quote(paste0(dt.download.final[!is.na(url_res_meeting_en)]$doc_id, "_MeetingRec_EN.pdf"))),
