...
tar_target(html.record.draft,
                f.download(url = dt.download$url_record_draft,
                           filename = paste0(stringi::stri_pad_left(dt.download$res_no, width = 4, pad = "0"), ".html"),
...
tar_target(ocrtest,
           f.ocr_quality_test(dt.res.en.gold = dt_res_en_gold,
                              dt.ocr.res.all = dt_ocr_res_all,
                              dt.extracted.res.all = dt_extracted_res_all))
