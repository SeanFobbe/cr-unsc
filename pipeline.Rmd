...
tar_target(f.download.table,
           f.download_table_create(record.table = record.table.final,
                                   sleep = runif(1, 1, 2),
                                   debug = TRUE,
...
tar_target(files.pdf.text.en,
                f.download(url = dt.download.table$url_text_en,
                           filename = paste0(dt.download.table$doc_id, "_EN.pdf"),
                           dir = "pdf_en",
                           sleep.min = 0.3,
                           sleep.max = 1,
                           retries = 3,
